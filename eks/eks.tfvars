cluster_name       = "do4m-eks-cluster"
name_prefix        = "do4m-eks-argocd-dev"
...
dns_hosted_zone              = "do4m.com"
load_balancer_name           = "do4m-eks-controller"
...
admin_users     = ["najibradzuan","terradmin"]
developer_users = ["dev01", "dev02"]
